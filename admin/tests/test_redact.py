...
Reprend la suite de `fiv_sourcing`, sur la copie du module qui vit ici : le
doublon n'a d'intérêt que si les deux se comportent pareil, et c'est
précisément ce que ces tests garantissent quand l'un des deux évolue.

Cas réel à l'origine de ces tests, côté sourcing : une clé TMDB v3 apparaissait
en clair dans chaque ligne de log de httpx, qui journalise l'URL complète de
ses requêtes.
"""
...
from fiv_admin.redact import SecretFilter, fingerprint, redact_dsn, redact_secrets
