...
export const TEXTES = {
  ...
  'fiche.synopsis_autre_langue': {
    fr: 'Résumé en {langue}, faute de version dans la vôtre.',
    en: 'Summary in {langue}, for want of one in your language.',
    es: 'Resumen en {langue}, a falta de una versión en tu idioma.',
    ar: 'الملخّص بـ{langue}، في غياب نسخة بلغتك.',
  },
  'langue.fr': { fr: 'français', en: 'French', es: 'francés', ar: 'الفرنسية' },
  'langue.en': { fr: 'anglais', en: 'English', es: 'inglés', ar: 'الإنجليزية' },
  'langue.es': { fr: 'espagnol', en: 'Spanish', es: 'español', ar: 'الإسبانية' },
  'langue.ar': { fr: 'arabe', en: 'Arabic', es: 'árabe', ar: 'العربية' },
  ...
  'personne.indice': {
    fr: 'Indice {indice}/10 — le poids de cette personne dans le catalogue',
    en: 'Index {indice}/10 — how much this person weighs in the catalogue',
    es: 'Índice {indice}/10 — el peso de esta persona en el catálogo',
    ar: 'مؤشّر {indice}/10 — وزن هذا الشخص في الفهرس',
  },
  ...
  // --- Le compte : connexion, inscription, vérification -----------------
  'compte.titre_connexion': { fr: 'Se connecter', en: 'Sign in', es: 'Iniciar sesión', ar: 'تسجيل الدخول' },
  'compte.titre_inscription': { fr: 'Créer un compte', en: 'Create an account', es: 'Crear una cuenta', ar: 'إنشاء حساب' },
  'compte.titre_code': { fr: 'Vérifiez votre email', en: 'Check your email', es: 'Verifica tu correo', ar: 'تحقّق من بريدك' },
  'compte.pourquoi': {
    fr: 'Vos fives sont à vous : un compte les garde, sur tous vos appareils.',
    en: 'Your fives are yours: an account keeps them, on all your devices.',
    es: 'Tus fives son tuyos: una cuenta los guarda, en todos tus dispositivos.',
    ar: 'قوائمك الخمسية ملكك: الحساب يحفظها على جميع أجهزتك.',
  },
  'compte.pseudo': { fr: 'Votre pseudo', en: 'Your nickname', es: 'Tu apodo', ar: 'اسمك المستعار' },
  'compte.email': { fr: 'Votre email', en: 'Your email', es: 'Tu correo', ar: 'بريدك الإلكتروني' },
  'compte.mot_de_passe': { fr: 'Mot de passe (8 caractères ou plus)', en: 'Password (8+ characters)', es: 'Contraseña (8+ caracteres)', ar: 'كلمة المرور (8 أحرف أو أكثر)' },
  'compte.genre': { fr: 'Vous êtes… (facultatif)', en: 'You are… (optional)', es: 'Eres… (opcional)', ar: 'أنت… (اختياري)' },
  'compte.fille': { fr: 'Une fille', en: 'A girl', es: 'Una chica', ar: 'فتاة' },
  'compte.garcon': { fr: 'Un garçon', en: 'A boy', es: 'Un chico', ar: 'فتى' },
  'compte.bouton_inscrire': { fr: 'Créer mon compte', en: 'Create my account', es: 'Crear mi cuenta', ar: 'أنشئ حسابي' },
  'compte.bouton_connecter': { fr: 'Me connecter', en: 'Sign me in', es: 'Conectarme', ar: 'سجّل دخولي' },
  'compte.bouton_verifier': { fr: 'Vérifier', en: 'Verify', es: 'Verificar', ar: 'تحقّق' },
  'compte.vers_inscription': { fr: 'Pas encore de compte ? Inscrivez-vous', en: 'No account yet? Sign up', es: '¿Sin cuenta? Regístrate', ar: 'لا حساب لديك؟ سجّل الآن' },
  'compte.vers_connexion': { fr: 'Déjà un compte ? Connectez-vous', en: 'Already have an account? Sign in', es: '¿Ya tienes cuenta? Conéctate', ar: 'لديك حساب؟ سجّل الدخول' },
  'compte.code_envoye': {
    fr: 'Un code à 6 chiffres vient de partir vers {email} — recopiez-le ici.',
    en: 'A 6-digit code was just sent to {email} — type it here.',
    es: 'Acabamos de enviar un código de 6 cifras a {email}: escríbelo aquí.',
    ar: 'أُرسل رمز من 6 أرقام إلى {email} — اكتبه هنا.',
  },
  'compte.code': { fr: 'Le code reçu', en: 'The code you received', es: 'El código recibido', ar: 'الرمز الذي وصلك' },
  'compte.renvoyer': { fr: 'Renvoyer un code', en: 'Send a new code', es: 'Reenviar un código', ar: 'أرسل رمزًا جديدًا' },
  'compte.code_renvoye': { fr: 'Code renvoyé !', en: 'Code sent!', es: '¡Código reenviado!', ar: 'أُعيد إرسال الرمز!' },
  'compte.erreur_connexion': {
    fr: 'Email ou mot de passe incorrect.',
    en: 'Wrong email or password.',
    es: 'Correo o contraseña incorrectos.',
    ar: 'البريد أو كلمة المرور غير صحيحة.',
  },
  'compte.erreur_existe': {
    fr: 'Un compte existe déjà avec cet email — connectez-vous.',
    en: 'An account already exists with this email — sign in.',
    es: 'Ya existe una cuenta con este correo: conéctate.',
    ar: 'يوجد حساب بهذا البريد — سجّل الدخول.',
  },
  'compte.erreur_code': {
    fr: 'Code incorrect ou expiré — redemandez-en un.',
    en: 'Wrong or expired code — ask for a new one.',
    es: 'Código incorrecto o caducado: pide otro.',
    ar: 'رمز خاطئ أو منتهي — اطلب واحدًا جديدًا.',
  },
  'compte.erreur': {
    fr: 'Ça n’a pas marché — réessayez dans un instant.',
    en: 'That didn’t work — try again in a moment.',
    es: 'No ha funcionado: inténtalo de nuevo en un momento.',
    ar: 'لم ينجح الأمر — أعد المحاولة بعد لحظات.',
  },
  'compte.bonjour': { fr: 'Bonjour {pseudo} !', en: 'Hello {pseudo}!', es: '¡Hola, {pseudo}!', ar: 'مرحبًا {pseudo}!' },
  'compte.deconnecter': { fr: 'Me déconnecter', en: 'Sign out', es: 'Cerrar sesión', ar: 'تسجيل الخروج' },
  ...
  'fives.consigne': {
    ...
    es: 'Toca una casilla, busca, elige: ya está.',
    ar: 'المس خانة، ابحث، اختر — هذا كل شيء.',
  },
  'fives.commencer': {
    fr: 'Commence ton premier five',
    en: 'Start your first five',
    es: 'Empieza tu primer five',
    ar: 'ابدأ خمسيتك الأولى',
  },
  'fives.garder': {
    fr: 'Garde ton five',
    en: 'Save your five',
  ...
  'fives.garder_note': {
    fr: 'Un compte (ou une connexion) et il est enregistré aussitôt.',
    en: 'One account (or a sign-in) and it is saved right away.',
  ...
  'fives.communaute': {
    ...
    en: 'Fives from the community',
    es: 'Los fives de la comunidad',
    ar: 'قوائم المجتمع الخمسية',
  },
  'fives.communaute_membre': {
    fr: 'Un membre de la communauté',
    en: 'A community member',
    es: 'Un miembro de la comunidad',
    ar: 'أحد أعضاء المجتمع',
  },
  'compte.menu_aria': { fr: 'Mon compte', en: 'My account', es: 'Mi cuenta', ar: 'حسابي' },
  'compte.mes_infos': { fr: 'Mes infos', en: 'My info', es: 'Mis datos', ar: 'بياناتي' },
  'compte.deconnexion': {
    fr: 'Se déconnecter',
    en: 'Sign out',
    es: 'Cerrar sesión',
  ...
  'compte.avatar_titre': { fr: 'Mon avatar', en: 'My avatar', es: 'Mi avatar', ar: 'صورتي' },
  'compte.enregistrer': { fr: 'Enregistrer', en: 'Save', es: 'Guardar', ar: 'حفظ' },
  'compte.enregistre': { fr: 'Enregistré !', en: 'Saved!', es: '¡Guardado!', ar: 'تم الحفظ!' },
  'compte.erreur_profil': {
  ...
  'fives.case_vide': { fr: 'Choisir', en: 'Pick one', es: 'Elegir', ar: 'اختر' },
  'fives.chercher': { fr: 'Cherchez votre n°{rang}…', en: 'Search your #{rang}…', es: 'Busca tu n.º{rang}…', ar: 'ابحث عن رقم {rang}…' },
  'fives.retirer': { fr: 'Retirer du rang {rang}', en: 'Remove from slot {rang}', es: 'Quitar del puesto {rang}', ar: 'أزل من المرتبة {rang}' },
  'fives.annuler': { fr: 'Annuler', en: 'Cancel', es: 'Cancelar', ar: 'إلغاء' },
  'fives.erreur': {
    fr: 'Vos fives ne répondent pas — réessayez dans un instant.',
    en: 'Your fives are not responding — try again in a moment.',
